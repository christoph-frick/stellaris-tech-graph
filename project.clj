(defproject factorio-graph "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "stg.core/on-js-reload"}

                :compiler {:main stg.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/stg.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/stg.js"
                           :main stg.core
